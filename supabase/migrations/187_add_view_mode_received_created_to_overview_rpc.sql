-- =====================================================
-- Migration 187: Add view_mode (received/created) tabs to overview RPC
-- =====================================================
--
-- Adds p_view_mode parameter to rpc_ticketing_overview_v2:
--   'received' = tickets where user is assignee (assigned_to)
--   'created'  = tickets where user is creator (created_by)
--
-- This filter applies ON TOP of the existing scope logic.
-- Example: Marketing Manager + 'received' = tickets in MKT dept assigned to me.
--
-- Leaderboard section is excluded from view_mode filter (always aggregate).
-- =====================================================

-- Drop old 4-param signature (migration 186)
DROP FUNCTION IF EXISTS public.rpc_ticketing_overview_v2(INTEGER, UUID, TEXT, TEXT);
...
BEGIN
    ...
    -- Scope logic (from migration 186)
