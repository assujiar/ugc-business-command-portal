-- =====================================================
-- Migration 017: Fix Lead Status Flow
-- Remove auto-transition from Qualified to Handed Over
-- Standardize status to use 'Assign to Sales' instead of 'Handed Over'
-- =====================================================

-- =====================================================
-- STEP 1: Add 'Assign to Sales' to enum
...
-- =====================================================
-- STEP 2: Migrate existing data from 'Handed Over' to 'Assign to Sales'
-- =====================================================

-- Update all leads with 'Handed Over' status to 'Assign to Sales'
UPDATE leads
SET triage_status = 'Assign to Sales'::lead_triage_status
WHERE triage_status = 'Handed Over'::lead_triage_status;

-- =====================================================
-- STEP 3: Update VIEW v_my_leads
-- Change filter from 'Handed Over' to 'Assign to Sales'
-- Also include claimed leads regardless of specific status
-- =====================================================
...
-- Remove auto-transition from Qualified to Handed Over
-- Use 'Assign to Sales' consistently
-- =====================================================

-- Drop and recreate rpc_lead_triage
...
-- Drop and recreate rpc_lead_handover_to_sales_pool (now renamed conceptually to assign to sales)
...
-- Update rpc_sales_claim_lead to not change triage_status
...
-- =====================================================
-- Summary of Changes:
-- 1. Added 'Assign to Sales' to lead_triage_status enum
-- 2. Migrated existing 'Handed Over' leads to 'Assign to Sales'
-- 3. Updated v_my_leads view to filter by claim_status = 'claimed'
