...
// Countries grouped by continent (ISO 3166-1 based)
export type CountryEntry = { name: string; code: string }
export type ContinentGroup = { continent: string; countries: CountryEntry[] }
...
export const COUNTRIES = COUNTRIES_BY_CONTINENT.flatMap(g => g.countries.map(c => c.name))
