...
export default async function DashboardPage({ searchParams }: PageProps) {
  ...
  let opportunitiesQuery = (adminClient as any).from('opportunities').select('opportunity_id, name, account_id, stage, estimated_value, owner_user_id, original_creator_id, created_at, closed_at, lost_reason, service_codes')
