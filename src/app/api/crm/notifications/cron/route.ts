...
export async function GET(request: NextRequest) {
  return NextResponse.json({
    ...
    usage: 'POST /api/crm/notifications/cron?type=<type>',
    documentation: {
    ...
    recommended_schedule: {
      unclaimed_leads: 'Every hour (0 * * * *)',
      pipeline_due: 'Every hour (0 * * * *)',
      overdue_pipeline: 'Every hour (0 * * * *)',
      inactivity: 'Daily at 09:00 WIB (0 2 * * *)',
      weekly_summary: 'Every Monday at 08:00 WIB (0 1 * * 1)',
    },
  })
}
